...
public class Q03_MethodCreation {
  ...
  */
    ...
    public static void fibonacci(int sayi) {
        ...
        if(sayi>0 && sayi<47){ // negatif girisleri kontrol etmek icin  0 dan buyuk sartı eklendi
            for (int i = 2; i <47 ; i++) {
                sayi3=sayi1+sayi2;
        ...
        }else System.out.println("47 den kucuk veya 0 dan buyuk bir sayi giriniz");
