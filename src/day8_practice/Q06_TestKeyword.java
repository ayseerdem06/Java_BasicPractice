...
*/
    ...
    private static void testSonucu(char[][] answers, char[] keys) {
        ...
        for (int i = 0; i <answers.length ; i++) {
            ...
            System.out.println(i+1 + " nolu ogrencının dogru cevap sayisi : "+ dogruCevapSayisi);
            System.out.println(i+1 + " nolu ogrencının yanlis cevap sayisi : "+yanlisCevapSayisi);
        }
