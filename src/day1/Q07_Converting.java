...
public class Q07_Converting {
    ...
    public static void main(String[] args) {
        ...
        String sonuc1 = gallon + " galon degeri " + litre + " litreye esittir "; //1000 galon degeri 3785.0 litreye esittir
        ...
        System.out.print("fahrenhayt degerini giriniz : ");
        double fh= scan.nextDouble();
        //c = (f-32)*5/9
        System.out.println("girdiginiz fahrahayt degeri : " + (fh-32)*5/9);
